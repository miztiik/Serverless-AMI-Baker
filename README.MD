...
![Fig : Serverless-Event-Driven-AMI-Creation](https://raw.githubusercontent.com/juanmancebo/Serverless-AMI-Baker/master/images/Serverless-Event-Driven-AMI-Creation.png)
...
- `Disable` retry attempts on asynchronous invocation(configure maximum-retry-attempts to 0). The default values is `2` , but is not recommended to this function because of his lack of idempotence
